...
const CircleProgress = () => {
  ...
  return (
    <div className=" flex flex-col items-center justify-center w-full">
      <div className="my-10 flex flex-row justify-around items-center lg:w-1/2 h-44 p-4 border rounded-xl shadow-xl">
        ...
        <div className="w-full space-y-1 px-4 flex flex-col flex-grow">
      ...
      <div className="flex flex-col border px-10 pb-8 pt-5 lg:w-1/2 bg-white shadow-2xl my-5 rounded-xl">
        <h2 className="text-3xl mb-5 tracking-wide">Perfomance</h2>

        <div className="flex items-center justify-between text-white p-3 rounded-lg shadow-xl bg-blue-400 mt-2 mb-5">
          <div className="w-32 p-3">
            ...
            <div className="absolute top-1/2 left-1/2 w-1/2 h-1/2">
              <CircularProgressbar
                value={16}
                text={`${16}`}
                styles={buildStyles({
          ...
          <div className="pr-2 md:pr-2 lg:pr-20">
